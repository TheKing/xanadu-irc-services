CC=gcc
INCLUDEDIR=../include
ANOPELIBS=-lnsl -lresolv  -ldl
CFLAGS=-pipe -g -O2 -export-dynamic
STRICT=-Wall -ansi -pedantic
PROFILE=-pg
LDPROFILE=
SHELL=/bin/sh
SUBDIRS=src
BINDEST=/home/ziber/xanadu/xanadu/
DATDEST=/home/ziber/xanadu/xanadu/
INSTALL=/usr/bin/install
RM=/bin/rm
CP=/bin/cp
TOUCH=/usr/bin/touch
MODULE_PATH=/home/ziber/xanadu/xanadu//modules/
MYSQL=
RDB=
LDFLAGS=
RUNGROUP=
